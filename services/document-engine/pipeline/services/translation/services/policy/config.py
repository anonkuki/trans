...
from services.translation.core.ocr.json_extractor import get_pages
from services.translation.services.policy.rule_profiles import DEFAULT_RULE_PROFILE_NAME
from services.translation.services.policy.rule_profiles import build_rule_profile_context
...
def build_translation_policy_config(
    *,
    ...
    enable_table_translation: bool | None = None,
    ...
    return TranslationPolicyConfig(
        ...
        enable_table_translation=bool(
            enable_table_translation if enable_table_translation is not None else False
        ),
