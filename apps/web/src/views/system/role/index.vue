<template>
    ...
    <el-table v-loading="loading" :data="list" @selection-change="handleRowCheckboxChange">
      ...
      <el-table-column :width="400" align="center" label="操作">
        <template #default="scope">
          ...
          <el-button
            v-hasPermi="['system:permission:assign-role-org']"
            link
            preIcon="ep:office-building"
            title="组织角色"
            type="primary"
            @click="openOrgPermissionForm(scope.row)"
          >
            组织角色
          </el-button>
          <el-button
  ...
  <!-- 表单弹窗：组织角色权限 -->
  <RoleOrgPermissionForm ref="orgPermissionFormRef" @success="getList" />
</template>
...
/** 组织角色权限操作 */
const orgPermissionFormRef = ref()
const openOrgPermissionForm = async (row: RoleApi.RoleVO) => {
  orgPermissionFormRef.value.open(row)
}
