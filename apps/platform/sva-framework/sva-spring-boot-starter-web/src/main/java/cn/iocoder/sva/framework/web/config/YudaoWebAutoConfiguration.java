package cn.iocoder.sva.framework.web.config;
...
import cn.iocoder.sva.framework.web.core.filter.CacheRequestBodyFilter;
import cn.iocoder.sva.framework.web.core.filter.DemoFilter;
import cn.iocoder.sva.framework.web.core.handler.GlobalExceptionHandler;
import cn.iocoder.sva.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class YudaoWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "sva.demo", havingValue = "true")
