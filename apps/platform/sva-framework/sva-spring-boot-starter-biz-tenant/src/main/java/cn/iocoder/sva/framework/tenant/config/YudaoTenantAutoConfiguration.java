...
import cn.iocoder.sva.framework.mybatis.core.util.MyBatisUtils;
import cn.iocoder.sva.framework.redis.config.YudaoCacheProperties;
import cn.iocoder.sva.framework.security.core.service.SecurityFrameworkService;
import cn.iocoder.sva.framework.tenant.core.aop.TenantIgnore;
import cn.iocoder.sva.framework.tenant.core.aop.TenantIgnoreAspect;
import cn.iocoder.sva.framework.tenant.core.db.TenantDatabaseInterceptor;
import cn.iocoder.sva.framework.tenant.core.job.TenantJobAspect;
import cn.iocoder.sva.framework.tenant.core.mq.rabbitmq.TenantRabbitMQInitializer;
import cn.iocoder.sva.framework.tenant.core.mq.redis.TenantRedisMessageInterceptor;
import cn.iocoder.sva.framework.tenant.core.mq.rocketmq.TenantRocketMQInitializer;
import cn.iocoder.sva.framework.tenant.core.redis.TenantRedisCacheManager;
import cn.iocoder.sva.framework.tenant.core.security.TenantSecurityWebFilter;
import cn.iocoder.sva.framework.tenant.core.service.TenantFrameworkService;
import cn.iocoder.sva.framework.tenant.core.service.TenantFrameworkServiceImpl;
import cn.iocoder.sva.framework.tenant.core.web.TenantContextWebFilter;
import cn.iocoder.sva.framework.tenant.core.web.TenantVisitContextInterceptor;
...
public class YudaoTenantAutoConfiguration {
    ...
    public TenantFrameworkService tenantFrameworkService(TenantCommonApi tenantApi) {
        // 参见 https://gitee.com/zhijiantianya/sva-cloud/issues/IC6YZF
        try {
     ...
     */
    @Configuration
    @ConditionalOnClass(name = "cn.iocoder.sva.framework.mq.redis.core.RedisMQTemplate")
    ...
    public RedisCacheManager tenantRedisCacheManager(RedisTemplate<String, Object> redisTemplate,
                                                     ...
                                                     YudaoCacheProperties kxCacheProperties,
                                                     TenantProperties tenantProperties) {
        // 创建 RedisCacheWriter 对象
        RedisConnectionFactory connectionFactory = Objects.requireNonNull(redisTemplate.getConnectionFactory());
        RedisCacheWriter cacheWriter = RedisCacheWriter.nonLockingRedisCacheWriter(connectionFactory,
                BatchStrategies.scan(kxCacheProperties.getRedisScanBatchSize()));
