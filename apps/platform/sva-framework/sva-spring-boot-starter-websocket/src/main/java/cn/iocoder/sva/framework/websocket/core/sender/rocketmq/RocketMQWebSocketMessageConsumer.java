package cn.iocoder.sva.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${sva.websocket.sender-rocketmq.topic}",
        consumerGroup = "${sva.websocket.sender-rocketmq.consumer-group}",
