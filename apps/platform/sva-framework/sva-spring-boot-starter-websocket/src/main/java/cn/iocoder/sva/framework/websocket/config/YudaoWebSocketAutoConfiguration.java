package cn.iocoder.sva.framework.websocket.config;

import cn.iocoder.sva.framework.mq.redis.config.YudaoRedisMQConsumerAutoConfiguration;
import cn.iocoder.sva.framework.mq.redis.core.RedisMQTemplate;
import cn.iocoder.sva.framework.websocket.core.handler.JsonWebSocketMessageHandler;
import cn.iocoder.sva.framework.websocket.core.listener.WebSocketMessageListener;
import cn.iocoder.sva.framework.websocket.core.security.LoginUserHandshakeInterceptor;
import cn.iocoder.sva.framework.websocket.core.security.WebSocketAuthorizeRequestsCustomizer;
import cn.iocoder.sva.framework.websocket.core.sender.kafka.KafkaWebSocketMessageConsumer;
import cn.iocoder.sva.framework.websocket.core.sender.kafka.KafkaWebSocketMessageSender;
import cn.iocoder.sva.framework.websocket.core.sender.local.LocalWebSocketMessageSender;
import cn.iocoder.sva.framework.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageConsumer;
import cn.iocoder.sva.framework.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageSender;
import cn.iocoder.sva.framework.websocket.core.sender.redis.RedisWebSocketMessageConsumer;
import cn.iocoder.sva.framework.websocket.core.sender.redis.RedisWebSocketMessageSender;
import cn.iocoder.sva.framework.websocket.core.sender.rocketmq.RocketMQWebSocketMessageConsumer;
import cn.iocoder.sva.framework.websocket.core.sender.rocketmq.RocketMQWebSocketMessageSender;
import cn.iocoder.sva.framework.websocket.core.session.WebSocketSessionHandlerDecorator;
import cn.iocoder.sva.framework.websocket.core.session.WebSocketSessionManager;
import cn.iocoder.sva.framework.websocket.core.session.WebSocketSessionManagerImpl;
...
@ConditionalOnProperty(prefix = "sva.websocket", value = "enable", matchIfMissing = true) // 允许使用 sva.websocket.enable=false 禁用 websocket
...
public class YudaoWebSocketAutoConfiguration {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "sva.websocket", name = "sender-type", havingValue = "local")
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "sva.websocket", name = "sender-type", havingValue = "redis")
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "sva.websocket", name = "sender-type", havingValue = "rocketmq")
    public class RocketMQWebSocketMessageSenderConfiguration {
        ...
        public RocketMQWebSocketMessageSender rocketMQWebSocketMessageSender(
                ...
                @Value("${sva.websocket.sender-rocketmq.topic}") String topic) {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "sva.websocket", name = "sender-type", havingValue = "rabbitmq")
    public class RabbitMQWebSocketMessageSenderConfiguration {
         ...
         */
        @Bean
        public TopicExchange websocketTopicExchange(@Value("${sva.websocket.sender-rabbitmq.exchange}") String exchange) {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "sva.websocket", name = "sender-type", havingValue = "kafka")
    public class KafkaWebSocketMessageSenderConfiguration {
        ...
        public KafkaWebSocketMessageSender kafkaWebSocketMessageSender(
                ...
                @Value("${sva.websocket.sender-kafka.topic}") String topic) {
