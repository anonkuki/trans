...
public class ProjectReactor {
    ...
    private static final String ARTIFACT_ID = "sva";
    private static final String PACKAGE_NAME = "cn.iocoder.sva";
    private static final String TITLE = "科兴管理系统";
