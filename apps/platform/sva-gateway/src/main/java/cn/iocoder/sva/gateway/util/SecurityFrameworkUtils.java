package cn.iocoder.sva.gateway.util;

import cn.hutool.core.map.MapUtil;
import cn.iocoder.sva.framework.common.util.json.JsonUtils;
import cn.iocoder.sva.gateway.filter.security.LoginUser;
 ...
 * 安全服务工具类
 *
 * copy from sva-spring-boot-starter-security 的 SecurityFrameworkUtils 类
 *
 * @author 科兴源码
 */
@Slf4j
