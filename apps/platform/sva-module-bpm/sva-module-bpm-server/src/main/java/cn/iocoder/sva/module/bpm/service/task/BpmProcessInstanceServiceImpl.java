package cn.iocoder.sva.module.bpm.service.task;
...
import cn.iocoder.sva.framework.common.util.collection.CollectionUtils;
import cn.iocoder.sva.framework.common.util.date.DateUtils;
import cn.iocoder.sva.framework.common.util.json.JsonUtils;
import cn.iocoder.sva.framework.common.util.object.ObjectUtils;
import cn.iocoder.sva.framework.common.util.object.PageUtils;
...
import cn.iocoder.sva.module.bpm.controller.admin.definition.vo.model.BpmModelMetaInfoVO;
import cn.iocoder.sva.module.bpm.controller.admin.definition.vo.model.simple.BpmSimpleModelNodeVO;
import cn.iocoder.sva.module.bpm.controller.admin.task.vo.instance.*;
import cn.iocoder.sva.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNodeTask;
import cn.iocoder.sva.module.bpm.controller.admin.task.vo.task.BpmTaskRespVO;
import cn.iocoder.sva.module.bpm.convert.task.BpmProcessInstanceConvert;
import cn.iocoder.sva.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO;
import cn.iocoder.sva.module.bpm.dal.redis.BpmProcessIdRedisDAO;
import cn.iocoder.sva.module.bpm.enums.ErrorCodeConstants;
import cn.iocoder.sva.module.bpm.enums.definition.BpmModelTypeEnum;
import cn.iocoder.sva.module.bpm.enums.definition.BpmSimpleModelNodeTypeEnum;
import cn.iocoder.sva.module.bpm.enums.task.BpmProcessInstanceStatusEnum;
import cn.iocoder.sva.module.bpm.enums.task.BpmReasonEnum;
import cn.iocoder.sva.module.bpm.enums.task.BpmTaskStatusEnum;
import cn.iocoder.sva.module.bpm.framework.flowable.core.candidate.BpmTaskCandidateInvoker;
import cn.iocoder.sva.module.bpm.framework.flowable.core.enums.BpmTaskCandidateStrategyEnum;
import cn.iocoder.sva.module.bpm.framework.flowable.core.enums.BpmnModelConstants;
import cn.iocoder.sva.module.bpm.framework.flowable.core.enums.BpmnVariableConstants;
import cn.iocoder.sva.module.bpm.framework.flowable.core.event.BpmProcessInstanceEventPublisher;
import cn.iocoder.sva.module.bpm.framework.flowable.core.util.BpmHttpRequestUtils;
import cn.iocoder.sva.module.bpm.framework.flowable.core.util.BpmnModelUtils;
import cn.iocoder.sva.module.bpm.framework.flowable.core.util.FlowableUtils;
import cn.iocoder.sva.module.bpm.framework.flowable.core.util.SimpleModelUtils;
import cn.iocoder.sva.module.bpm.service.definition.BpmProcessDefinitionService;
import cn.iocoder.sva.module.bpm.service.message.BpmMessageService;
import cn.iocoder.sva.module.system.api.dept.DeptApi;
import cn.iocoder.sva.module.system.api.dept.dto.DeptRespDTO;
import cn.iocoder.sva.module.system.api.user.AdminUserApi;
import cn.iocoder.sva.module.system.api.user.dto.AdminUserRespDTO;
...
import static cn.iocoder.sva.framework.common.util.collection.CollectionUtils.*;
import static cn.iocoder.sva.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNode;
import static cn.iocoder.sva.module.bpm.enums.ErrorCodeConstants.*;
import static cn.iocoder.sva.module.bpm.framework.flowable.core.enums.BpmnModelConstants.START_USER_NODE_ID;
import static cn.iocoder.sva.module.bpm.framework.flowable.core.util.BpmnModelUtils.parseNodeType;
...
public class BpmProcessInstanceServiceImpl implements BpmProcessInstanceService {
    ...
    @DataPermission(enable = false) // 关闭数据权限，避免查询不到用户数据。相关案例：https://gitee.com/zhijiantianya/sva-cloud/issues/ID1UYA
