...
import cn.iocoder.sva.framework.test.core.util.AssertUtils;
import cn.iocoder.sva.framework.test.core.util.RandomUtils;
import cn.iocoder.sva.module.bpm.controller.admin.definition.vo.group.BpmUserGroupSaveReqVO;
import cn.iocoder.sva.module.bpm.controller.admin.definition.vo.group.BpmUserGroupPageReqVO;
import cn.iocoder.sva.module.bpm.dal.dataobject.definition.BpmUserGroupDO;
import cn.iocoder.sva.module.bpm.dal.mysql.definition.BpmUserGroupMapper;
...
import static cn.iocoder.sva.module.bpm.enums.ErrorCodeConstants.USER_GROUP_NOT_EXISTS;
...
public class BpmUserGroupServiceTest extends BaseDbUnitTest {
    ...
    public void testGetUserGroupPage() {
       ...
       // 测试 name 不匹配
       userGroupMapper.insert(cloneIgnoreId(dbUserGroup, o -> o.setName("科兴")));
       // 测试 status 不匹配
