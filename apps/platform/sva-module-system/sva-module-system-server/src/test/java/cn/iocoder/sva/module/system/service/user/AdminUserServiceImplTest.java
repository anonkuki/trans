package cn.iocoder.sva.module.system.service.user;
...
import cn.iocoder.sva.framework.common.util.collection.ArrayUtils;
...
import cn.iocoder.sva.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import cn.iocoder.sva.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import cn.iocoder.sva.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import cn.iocoder.sva.module.system.controller.admin.user.vo.user.UserImportRespVO;
import cn.iocoder.sva.module.system.controller.admin.user.vo.user.UserPageReqVO;
import cn.iocoder.sva.module.system.controller.admin.user.vo.user.UserSaveReqVO;
...
import cn.iocoder.sva.module.system.dal.dataobject.tenant.TenantDO;
...
import cn.iocoder.sva.module.system.service.dept.PostService;
...
import static cn.iocoder.sva.framework.common.util.collection.SetUtils.asSet;
...
import static cn.iocoder.sva.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn(success("kxyuanma"));
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("kxyuanma");
        ...
        assertEquals("kxyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("kxyuanma"))).thenReturn("java");
