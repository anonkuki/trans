package cn.iocoder.sva.module.system.service.tenant;

import cn.iocoder.sva.framework.common.enums.CommonStatusEnum;
import cn.iocoder.sva.framework.common.pojo.PageResult;
import cn.iocoder.sva.framework.tenant.config.TenantProperties;
...
import cn.iocoder.sva.module.system.controller.admin.tenant.vo.tenant.TenantPageReqVO;
import cn.iocoder.sva.module.system.controller.admin.tenant.vo.tenant.TenantSaveReqVO;
...
import cn.iocoder.sva.module.system.dal.dataobject.tenant.TenantPackageDO;
import cn.iocoder.sva.module.system.dal.mysql.tenant.TenantMapper;
import cn.iocoder.sva.module.system.enums.permission.RoleCodeEnum;
import cn.iocoder.sva.module.system.enums.permission.RoleTypeEnum;
...
import cn.iocoder.sva.module.system.service.tenant.handler.TenantInfoHandler;
import cn.iocoder.sva.module.system.service.tenant.handler.TenantMenuHandler;
...
import static cn.iocoder.sva.module.system.dal.dataobject.tenant.TenantDO.PACKAGE_ID_SYSTEM;
...
public class TenantServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateTenant() {
        ...
        when(userService.createUser(argThat(user -> {
            ...
            assertEquals("科兴", user.getNickname());
    ...
    public void testGetTenantByName() {
        // mock 数据
        TenantDO dbTenant = randomPojo(TenantDO.class, o -> o.setName("科兴"));
        tenantMapper.insert(dbTenant);// @Sql: 先插入出一条存在的数据

        // 调用
        TenantDO result = tenantService.getTenantByName("科兴");
        // 校验存在
        assertPojoEquals(result, dbTenant);
    }
