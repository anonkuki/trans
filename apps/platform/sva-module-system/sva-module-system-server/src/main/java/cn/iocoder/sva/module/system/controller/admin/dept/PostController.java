package cn.iocoder.sva.module.system.controller.admin.dept;
...
import cn.iocoder.sva.module.system.controller.admin.dept.vo.post.PostRespVO;
import cn.iocoder.sva.module.system.controller.admin.dept.vo.post.PostSaveReqVO;
...
public class PostController {
    ...
    @Operation(summary = "根据岗位ID列表获取岗位信息", description = "用于回显已选中的岗位")
    public CommonResult<List<PostSimpleRespVO>> getPostListByIds(@RequestParam("ids") List<Long> ids) {
        List<PostDO> posts = postService.getPostList(ids);
        return success(BeanUtils.toBean(posts, PostSimpleRespVO.class));
    }
