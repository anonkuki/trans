...
@Schema(description = "管理后台 - 人员信息同步分页 Request VO")
@Data
public class SyncPersonPageReqVO extends PageParam {

    @Schema(description = "唯一ID", example = "29179")
    private String guid;
    ...
    @Schema(description = "员工ID", example = "18531")
