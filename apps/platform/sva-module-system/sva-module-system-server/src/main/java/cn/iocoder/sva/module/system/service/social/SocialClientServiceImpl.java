...
import cn.iocoder.sva.framework.common.util.cache.CacheUtils;
import cn.iocoder.sva.framework.common.util.http.HttpUtils;
import cn.iocoder.sva.framework.common.util.object.BeanUtils;
import cn.iocoder.sva.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import cn.iocoder.sva.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import cn.iocoder.sva.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import cn.iocoder.sva.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import cn.iocoder.sva.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import cn.iocoder.sva.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import cn.iocoder.sva.module.system.dal.dataobject.social.SocialClientDO;
import cn.iocoder.sva.module.system.dal.mysql.social.SocialClientMapper;
...
import static cn.iocoder.sva.framework.common.util.collection.MapUtils.findAndThen;
import static cn.iocoder.sva.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static cn.iocoder.sva.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${sva.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${sva.wxa-subscribe-message.miniprogram-state:formal}")
    ...
    AuthRequest buildAuthRequest(Integer socialType, Integer userType) {
        ...
        AuthRequest request = authRequestFactory.get(source);
    ...
    public void uploadWxaOrderShippingInfo(Integer userType, SocialWxaOrderUploadShippingInfoReqDTO reqDTO) {
        ...
        // 对应 ISSUE：https://gitee.com/zhijiantianya/sva-cloud/pulls/230
