...
import cn.iocoder.sva.module.system.dal.dataobject.permission.RoleMenuDO;
...
import cn.iocoder.sva.module.system.dal.mysql.permission.RoleMenuMapper;
...
public class PermissionServiceImpl implements PermissionService {
    ...
    public Set<Long> getLoginUserAllRoleIds(Long userId) {
        ...
        if (user != null && user.getDeptId() != null) {
            List<DeptRoleDO> deptRoleList = deptRoleMapper.selectList(
                new QueryWrapper<DeptRoleDO>()
                    .eq("dept_id", user.getDeptId())
            );
            if (CollUtil.isNotEmpty(deptRoleList)) {
    ...
    @Override
    public void assignRoleDeptScope(Long roleId, Integer dataScope, Set<Long> dataScopeDeptIds) {
        roleService.updateRoleDeptScope(roleId, dataScope, dataScopeDeptIds);
    }

    @Override
    public Set<Long> getDeptIdListByRoleId(Long roleId) {

        List<DeptRoleDO> deptRoleList = deptRoleMapper.selectList(new QueryWrapper<DeptRoleDO>().eq("role_id", roleId));

        Set<Long> result = new HashSet<>();
        for (DeptRoleDO deptRoleDO : deptRoleList) {
            result.add(deptRoleDO.getDeptId());
        }
