package cn.iocoder.sva.module.system.controller.admin.permission.vo.role;
...
public class RoleSaveReqVO {
    ...
    @Schema(description = "所属角色", requiredMode = Schema.RequiredMode.REQUIRED, example = "1")
    @DiffLogField(name = "所属角色")
