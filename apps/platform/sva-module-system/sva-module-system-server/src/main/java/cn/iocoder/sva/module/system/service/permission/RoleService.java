...
public interface RoleService {
     ...
     * @param dataScopeDeptIds 部门编号数组
     */
    void updateRoleDeptScope(Long id, Integer dataScope, Set<Long> dataScopeDeptIds);
    ...
    List<RoleDO> getRoleList(QueryWrapper<RoleDO> wrapper);
     ...
     *
     */
    List<RoleDO> getRoleListSelf(RolePageReqVO reqVO);

    List<RoleDO> getRoleSelf(Set<Long> roleList);
