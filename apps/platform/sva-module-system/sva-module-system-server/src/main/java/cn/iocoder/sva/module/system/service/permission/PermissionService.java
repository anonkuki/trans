...
public interface PermissionService {
    ...
    /**
     * 获得登录用户的全部角色编号集合(包含直接分配和部门分配的角色)
     *
     * @param userId 用户编号
     * @return 角色编号集合
     */
    Set<Long> getLoginUserAllRoleIds(Long userId);
     ...
     * @param dataScopeDeptIds 部门编号数组
     */
    void assignRoleDeptScope(Long roleId, Integer dataScope, Set<Long> dataScopeDeptIds);
     ...
     * @return 角色编号集合
     */
    Set<Long> getDeptIdListByRoleId(Long roleId);
