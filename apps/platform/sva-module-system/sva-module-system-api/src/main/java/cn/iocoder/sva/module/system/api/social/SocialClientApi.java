package cn.iocoder.sva.module.system.api.social;

import cn.iocoder.sva.framework.common.pojo.CommonResult;
import cn.iocoder.sva.module.system.api.social.dto.*;
...
public interface SocialClientApi {
    ...
    @Parameters({
            @Parameter(name = "userType", description = "用户类型", example = "1", required = true),
            @Parameter(name = "phoneCode", description = "手机授权码", example = "kx11", required = true)
    })
