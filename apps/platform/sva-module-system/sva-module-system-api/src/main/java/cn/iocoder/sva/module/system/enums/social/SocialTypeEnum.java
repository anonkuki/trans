package cn.iocoder.sva.module.system.enums.social;

import cn.hutool.core.util.ArrayUtil;
import cn.iocoder.sva.framework.common.core.ArrayValuable;
...
public enum SocialTypeEnum implements ArrayValuable<Integer> {
     ...
     * 飞书
     *
     * @see <a href="https://open.feishu.cn/document/authentication-management/access-token/get-user-access-token">接入文档</a>
     */
    FEISHU(50, "FEISHU"),
    ;
