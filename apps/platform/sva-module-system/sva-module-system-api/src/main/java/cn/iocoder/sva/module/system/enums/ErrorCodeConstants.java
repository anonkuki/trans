...
public interface ErrorCodeConstants {
    ...
    ErrorCode SOCIAL_FEISHU_TOKEN_ERROR = new ErrorCode(1_002_018_002, "获取飞书授权access_token失败！");
    ...
    ErrorCode SYNC_DEPT_NOT_EXISTS = new ErrorCode(1_002_029_000, "部门信息同步不存在");

    ErrorCode SYNC_PERSON_NOT_EXISTS = new ErrorCode(1_002_029_001, "人员信息同步不存在");
    ErrorCode SYNC_POSITION_NOT_EXISTS = new ErrorCode(1_002_029_002, "岗位信息同步不存在");
    ErrorCode SYNC_STAFF_NOT_EXISTS = new ErrorCode(1_002_029_003, "全部人员信息同步不存在");
