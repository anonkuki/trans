package cn.iocoder.sva.module.ai.enums;
...
public interface ErrorCodeConstants {
    ...
    // AI 工作流 - 执行异常
    ErrorCode WORKFLOW_EXECUTE_ERROR = new ErrorCode(1_040_011_002, "工作流执行异常");

    ErrorCode FEISHU_MESSAGE_NOT_EXISTS = new ErrorCode(1_040_021_002, "飞书消息接收记录不存在");

    ErrorCode TRAN_GLOSSARY_NOT_EXISTS = new ErrorCode(1_040_031_001, "术语库管理不存在");
    ErrorCode TRAN_GLOSSARY_ITEM_NOT_EXISTS = new ErrorCode(1_040_031_002, "术语管理不存在");
    ErrorCode TRAN_GLOSSARY_NO_PERMISSION = new ErrorCode(1_040_031_003, "无权操作该术语库");
