package cn.iocoder.sva.module.ai.service.model;
...
import cn.iocoder.sva.module.ai.controller.admin.model.vo.model.AiModelPageReqVO;
import cn.iocoder.sva.module.ai.controller.admin.model.vo.model.AiModelSaveReqVO;
import cn.iocoder.sva.module.ai.dal.dataobject.model.AiApiKeyDO;
import cn.iocoder.sva.module.ai.dal.dataobject.model.AiModelDO;
import cn.iocoder.sva.module.ai.dal.mysql.model.AiChatMapper;
...
public class AiModelServiceImpl implements AiModelService {
    ...
    public ChatModel getChatModel(Long id) {
        ...
        log.info("[getChatModel] 获取 ChatModel, modelId={}, modelName={}, model={}, platform={}, keyId={}, url={}, temperature={}", 
                id, model.getName(), model.getModel(), platform.getPlatform(), model.getKeyId(), apiKey.getUrl(), model.getTemperature());
        
        ChatModel chatModel = modelFactory.getOrCreateChatModel(platform, apiKey.getApiKey(), apiKey.getUrl(), model.getModel(), model.getTemperature());
        
        log.info("[getChatModel] 成功创建 ChatModel 实例, modelId={}, chatModelType={}, configuredModel={}", 
                id, chatModel.getClass().getSimpleName(), model.getModel());
