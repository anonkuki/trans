package cn.iocoder.sva.module.ai.controller.admin.chat;
...
public class AiChatMessageController {
    ...
    public CommonResult<PageResult<AiChatMessageRespVO>> getChatMessagePage(AiChatMessagePageReqVO pageReqVO) {
        ...
        // 获取所有用户ID，批量查询用户信息
        List<Long> userIds = convertList(pageResult.getList(), AiChatMessageDO::getUserId);
        ...
        return success(BeanUtils.toBean(pageResult, AiChatMessageRespVO.class,
                respVO -> {
                    ...
                    respVO.setUserName(finalUserNameMap.get(respVO.getUserId()));
                }));
    }
