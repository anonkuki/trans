...
public interface AiModelFactory {
     ...
     * @param url API URL
     * @param model 模型名称（从数据库获取）
     * @param temperature 温度参数（从数据库获取，可为null）
     * @return ChatModel 对象
     */
    ChatModel getOrCreateChatModel(AiPlatformEnum platform, String apiKey, String url, String model, Double temperature);
