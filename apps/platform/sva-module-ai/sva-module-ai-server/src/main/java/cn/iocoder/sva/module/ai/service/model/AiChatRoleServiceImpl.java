...
import cn.iocoder.sva.module.ai.dal.mysql.model.AiChatRoleMapper;
import cn.iocoder.sva.module.ai.service.knowledge.AiKnowledgeService;
...
import static cn.iocoder.sva.module.ai.enums.ErrorCodeConstants.CHAT_ROLE_DISABLE;
import static cn.iocoder.sva.module.ai.enums.ErrorCodeConstants.CHAT_ROLE_NOT_EXISTS;
...
public class AiChatRoleServiceImpl implements AiChatRoleService {
    ...
    @Override
    public List<AiChatRoleDO> getChatRoleListByCategory(String category) {
        return chatRoleMapper.selectListByCategory(category);
    }
