package cn.iocoder.sva.module.ai.dal.mysql.model;
...
public interface AiChatRoleMapper extends BaseMapperX<AiChatRoleDO> {
    ...
    default List<AiChatRoleDO> selectListByCategory(String category) {
        return selectList(new LambdaQueryWrapperX<AiChatRoleDO>()
                .eqIfPresent(AiChatRoleDO::getCategory, category)
