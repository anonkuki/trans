package cn.iocoder.sva.module.ai.controller.admin.model;
...
import cn.iocoder.sva.module.ai.controller.admin.model.vo.chatRole.AiChatRolePageReqVO;
import cn.iocoder.sva.module.ai.controller.admin.model.vo.chatRole.AiChatRoleRespVO;
import cn.iocoder.sva.module.ai.controller.admin.model.vo.chatRole.AiChatRoleSaveMyReqVO;
import cn.iocoder.sva.module.ai.controller.admin.model.vo.chatRole.AiChatRoleSaveReqVO;
...
public class AiChatRoleController {
    ...
    @Operation(summary = "根据分类获得聊天角色列表")
    @Parameter(name = "category", description = "角色分类", required = true, example = "翻译助手")
    @TransMethodResult
    public CommonResult<List<AiChatRoleRespVO>> getChatRoleListByCategory(@RequestParam("category") String category) {
        List<AiChatRoleDO> list = chatRoleService.getChatRoleListByCategory(category);
        return success(BeanUtils.toBean(list, AiChatRoleRespVO.class));
    }
